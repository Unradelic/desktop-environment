...
function WarpSpeed(targetId,config){
	...
	this.TARGET_SPEED=config.initialSpeed==undefined||config.initialSpeed<0?this.SPEED:config.initialSpeed;
	this.TARGET_SPEED_OLD=config.targetSpeed==undefined||config.targetSpeed<0?this.SPEED:config.targetSpeed;
...
WarpSpeed.prototype={
	...
	ready:function(){
		this.TARGET_SPEED=this.TARGET_SPEED_OLD;
	},
	draw:function(){
		var TIME=timeStamp();
